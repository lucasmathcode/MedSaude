...
public class Interface_02 extends javax.swing.JDialog {

    
    public Interface_02(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("MedSaúde+");
    ...
    private void initComponents() {
        ...
        jButton1.setText("SOU FUNCIONÁRIO");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        Interface_02_senhaMed dialog = new Interface_02_senhaMed(new javax.swing.JFrame(),true);
        dialog.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Interface_02.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
